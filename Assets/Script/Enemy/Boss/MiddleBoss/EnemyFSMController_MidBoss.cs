...
public class EnemyFSMController_MidBoss : EnemyController
{
    // 중간보스 상태들
    public enum STATE { IDLE, MOVE, DETECT, ATTACK, GIVEUP, HIT, DEATH, DEFENSE, REBOUND }
    ...
    public void EnemyNomalAtteckAnimationEvent()
    {
        ...
        foreach (Collider hit in hits)
        {
            ...
            if (angleToTarget < hitAngle)
            {
                ...
                {
                    // 적군 패링 영향
                    gameObject.GetComponent<EnemyAttackState_MidBoss>().OnRebound = true;
                    return;
                }
    ...
    public void DashSoundEvent()
    {
        movementAudio.clip = dashClip;
        movementAudio.Play();
